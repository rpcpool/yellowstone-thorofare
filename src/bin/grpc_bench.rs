use {
    ...
    std::{fs, time::Instant},
    tracing::{error, info},
    yellowstone_grpc_bench::{
        Collector, Processor, Config,
    },
};
...
async fn main() -> Result<()> {
    ...
    match collector.run().await {
        Ok((data1, data2, ping1, ping2)) => {
            ...
            // Print summary
            info!("\n=== BENCHMARK SUMMARY ===");
            info!("Total slots collected: {}", result.metadata.total_slots_collected);
            ...
            info!("Waiting Time: p50={:.2}, p90={:.2}, p99={:.2}", 
            ...
            info!("Download Time: p50={:.2}, p90={:.2}, p99={:.2}", 
            ...
            info!("Finalization Time: p50={:.2}, p90={:.2}, p99={:.2}", 
